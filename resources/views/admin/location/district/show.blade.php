        ...
        <div class="card card_line">
            ...
            <div class="card-body">
                ...
                @if(Auth::check() && Auth::user()->role == 'admin' && (Auth::user()->title || Auth::user()->license || Auth::user()->title_bn || Auth::user()->license_bn || Auth::user()->title_ar || Auth::user()->license_ar))
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('admin.district.edit', ['id'=>$district_single_data[0]->id]) }}">Update Name</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('admin.district.editInfo', ['id'=>$district_single_data[0]->id]) }}">Update Info</a>
                @endif
