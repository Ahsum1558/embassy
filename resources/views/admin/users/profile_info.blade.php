...
<div class="row">
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            ...
            <div class="card-body">
                <h4 class="mb-4 basic_headline">Update Info</h4>
                    ...
                    <form action="{{ route('admin.profile.infoUpdate') }}" class="form-group" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="profile-personal-info">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9"><input type="text" name="name" class="form-control d-inline-block inline_setup" value="{{ $user_info->name }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-3">
                                ...
                                <div class="col-9"><input type="text" name="designation" class="form-control d-inline-block inline_setup" value="{{ $user_info->designation }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-3">
                        ...
                        <div class="profile-personal-info">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9"><span><input type="text" name="phone" class="form-control d-inline-block inline_setup" value="{{ $user_info->phone }}"></span>
                                </div>
                            </div>
                        </div>
                        <div class="profile-personal-info">
                            ...
                            <div class="row mb-2">
                                <div class="col-3">
                                    <h5 class="f-w-500">Company Full Address in Bengali<span class="pull-right">:</span></h5>
                                </div>
                        ...
                        <div class="profile-personal-info">
                            ...
                            <div class="row mb-2">
                                <div class="col-3">
                                    <h5 class="f-w-500">Company Full Address in Arabic<span class="pull-right">:</span></h5>
                                </div>
                        ...
                        <div class="profile-personal-info">
                            <div class="row mb-2">
                                <div class="col-12">
                                    <h4 class="f-w-500 text-center">Company Location Information</h4>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-3">
                                    <h5 class="f-w-500">Company Location<span class="pull-right">:</span></h5>
                                </div>
