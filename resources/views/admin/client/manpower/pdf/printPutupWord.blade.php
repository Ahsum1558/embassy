...
<head>
    ...
    <link href="{{ asset('public/admin/assets/css/pdf/putupprintWord.css') }}" rel="stylesheet">
    <style>
        .page-break {
...
<body>
    <div id="exportContent" class="app_wrapper clear">
@php
...
@endphp
    ...
    <div class="button_download" style="width: 100%; clear: both; margin: 0 auto; text-align: center;">
        <button style="background-color: green; color: #fff; font-size: 15px; padding: 10px 20px; border: none; cursor: pointer;" onclick="Export2Doc('exportContent', 'document_name');">Export as .doc</button>
    </div>
