    ...
    <div class="col-12">
        <div class="card card_line">
            <div class="card-header card_headline">
                <h4 class="card-title headline">Update Info of <strong>{{ $customer_data_info->cusFname .' '. $customer_data_info->cusLname }}</strong></h4>
            </div>
            <div class="card-body">
@include('admin.includes.alert')
                <form action="{{ route('admin.customer.update', ['id'=>$customer_data_info->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                        <div class="product-detail-content">
                            ...
                            <div class="new-arrival-content pr">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9"><input type="text" name="phone" class="form-control d-inline-block inline_setup" value="{{ $customer_data_info->phone }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    @foreach($all_delegate as $delegate)
                                      <option value="{{ $delegate->id }}" {{ $customer_data_info->agentId == $delegate->id ? 'selected' : '' }}>{{ $delegate->agentname .' - '. $delegate->agentsl }}</option>
                                    @endforeach
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    @foreach($all_visa_trade as $trade)
                                      <option value="{{ $trade->id }}" {{ $customer_data_info->tradeId == $trade->id ? 'selected' : '' }}>{{ $trade->visatrade_name }}</option>
                                    @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    @foreach($all_country as $country)
                                      <option value="{{ $country->id }}" {{ $customer_data_info->countryFor == $country->id ? 'selected' : '' }}>{{ $country->countryname }}</option>
                                    @endforeach
                                        </select>
                                    </div>
                                </div>
