...
@include('admin.includes.alert')
                <form action="{{ route('admin.visa.store') }}" class="form-group" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="profile-personal-info">
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                <h4 class="f-w-500 text-center">All <span class="text-danger font-weight-bold">(*)</span> fields must be completed</h4>
                            </div>
                        </div>

                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Visa No. in English<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Visa No. in Arabic<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Sponsor Id No. in English<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Sponsor Id No. in Arabic<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Sponsor Name in English<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Sponsor Name in Arabic<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Visa Date in Hijri<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Visa Occupation in English<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Visa Occupation in Arabic<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Visa Delegation/ Wakaalah No.<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Visa Delegation/ Wakaalah Date<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Total Delegated Visa<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Contract Duration<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-3">
                                <h5 class="f-w-500">Status<span class="text-danger font-weight-bold">*</span><span class="pull-right">:</span></h5>
                            </div>
                            <div class="col-9">
