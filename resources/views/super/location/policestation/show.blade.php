    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            ...
            <div class="card-body">
                            ...
                            <div class="profile-personal-info">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9"><span>
                                        @if($upzila_single_data[0]->status == 1)
                                            {{ __('Active') }}
                                            @elseif($upzila_single_data[0]->status == 0)
                                            {{ __('Inactive') }}
                                        @endif
                                    </span>
                                    </div>
                ...
                <div class="mybtn">
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.policestation.edit', ['id'=>$upzila_single_data[0]->id]) }}">Update Name</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.policestation.editInfo', ['id'=>$upzila_single_data[0]->id]) }}">Update Info</a>
