    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            ...
            <div class="card-body">
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="profile-personal-info">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9"><span>{{ $single_country->currency }}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><span>{{ $single_country->phone_code }}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                ...
                <div class="mybtn">
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.country.edit', ['id'=>$single_country->id]) }}">Update</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.country.editnative', ['id'=>$single_country->id]) }}">Update Nationality</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.country.editCurrency', ['id'=>$single_country->id]) }}">Update Currency</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('super.country') }}">Back</a>
                </div>
            </div>
        </div>
    </div>
