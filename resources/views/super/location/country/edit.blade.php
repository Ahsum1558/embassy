...
@include('super.includes.alert')
                <form action="{{ route('super.country.update', ['id'=>$country_data->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                        <div class="product-detail-content">
                            ...
                            <div class="new-arrival-content pr">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9"><span><input type="text" name="currency" class="form-control d-inline-block inline_setup" value="{{ $country_data->currency }}"></span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><span><input type="text" name="nationality" class="form-control d-inline-block inline_setup" value="{{ $country_data->nationality }}"></span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><span><input type="text" name="phone_code" class="form-control d-inline-block inline_setup" value="{{ $country_data->phone_code }}"></span>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9 mybtn">
                                        ...
                                        <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('super.country.show', ['id'=>$country_data->id]) }}">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
