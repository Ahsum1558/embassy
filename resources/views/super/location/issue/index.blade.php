...
<div class="mybtn">
    <a href="{{ route('super.issue.create') }}" class="btn submitbtn mb-2 form-control inline_setup text-uppercase">Add New Issue Place</a>
</div>
<div class="row">
        ...
        <div class="card card_line">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                  <table id="example" class="display" style="min-width: 700px">
                      ...
                      @foreach($all_issue as $issue)
                        <tr>
                            ...
                            <td>
                              <a class="view_option" href="{{ route('super.issue.show', ['id'=>$issue->id]) }}"><i class="fas fa-eye"></i><span>View Details</span></a>
                            @if($issue->status == 1)
                              <a class="edit_option bg-warning" href="#inActiveId{{ $issue->id }}" data-toggle="modal"><i class="fas fa-caret-square-down"></i><span>Set Inactive</span></a>
                            @elseif($issue->status == 0)
                ...
                @include('super.location.issue.issue_modal')
                @include('super.location.issue.issue_active')
                @include('super.location.issue.issue_inactive')
                        </tr>
               @endforeach
                      </tbody>
                  </table>
