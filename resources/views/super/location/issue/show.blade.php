    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            ...
            <div class="card-body">
                ...
                <div class="mybtn">
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.issue.edit', ['id'=>$issue_single_data[0]->id]) }}">Update Name</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.issue.editInfo', ['id'=>$issue_single_data[0]->id]) }}">Update Info</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('super.issue') }}">Back</a>
                </div>
            </div>
        </div>
    </div>
