...
@include('super.includes.alert')
                <form action="{{ route('super.district.updateInfo', ['id'=>$district_data_info[0]->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                        <div class="product-detail-content">
                            ...
                            <div class="new-arrival-content pr">
                                ...
                                @if($district_data_info[0]->status == 1)
                                          <option selected="selected" value="1">Active</option>
                                          <option value="0">Inactive</option>
                                  @elseif($district_data_info[0]->status == 0)
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9 mybtn">
                                        ...
                                        <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('super.district.show', ['id'=>$district_data_info[0]->id]) }}">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
