...
@include('super.includes.alert')
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Super Image Update</a></li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            <div class="card-header card_headline">
               <h4 class="card-title headline">Super Profile Image Update</h4>
            </div>
            <div class="card-body">
                <h4 class="mb-4 basic_headline">Update Personal Image</h4>
                <div class="settings-form">
                    <form action="{{ route('super.profile.imageUpdate') }}" class="form-group" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <div class="profile-photo"> 
                                <img id="showImage" class="img-fluid img_user rounded-circle" src="{{ (!empty($superData->photo)) ? url('public/admin/uploads/super/'.$superData->photo) : url('public/admin/assets/images/avatar.png') }}" alt="">  
                                <input id="imageUploading" type="file" name="new_photo" class="form-control">
                                <input id="imageUploading" type="hidden" name="old_photo" class="form-control" value="{{ $superData->photo }}">
                            </div>
                        </div>
