...
@include('super.includes.alert')
                <form action="{{ route('super.field.updateTitle', ['id'=>$field_data_title->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                        <div class="product-detail-content">
                            ...
                            <div class="new-arrival-content pr">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9"><span><input type="text" name="title" class="form-control d-inline-block inline_setup" value="{{ $field_data_title->title }}"></span>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9 mybtn">
                                        ...
                                        <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('super.field.show', ['id'=>$field_data_title->id]) }}">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
