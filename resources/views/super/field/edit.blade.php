...
<div class="row page-titles mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Field Area</a></li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card card_line">
            <div class="card-header card_headline">
                <h4 class="card-title headline">Update Field Area Info</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('super.field.update', ['id'=>$field_data->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        <div class="product-detail-content">
                            ...
                            @if($field_data->status == 1)
                                      <option selected="selected" value="1">Active</option>
                                      <option value="0">Inactive</option>
                              @elseif($field_data->status == 0)
