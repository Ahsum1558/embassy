<div class="col-xl-12 col-lg-12">
    <div class="card card_line">
        ...
        <div class="card-body">
                    ...
                    <div class="col-xl-12 col-sm-12">
                        <div class="profile-personal-info">
                            <div class="row mb-2">
                                ...
                                <div class="col-9"><span>{{ $single_user[0]->payment_data }}</span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-3">
                                ...
                                <div class="col-9"><span>{{ $single_user[0]->trans_amount }}</span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-3">
                                ...
                                <div class="col-9"><span>
                                    @if($single_user[0]->trans_date !== NULL)
                                        {{ date('d-M-Y', strtotime($single_user[0]->trans_date)) }}
                                    @else
                                        {{ __('N/A') }}
                                    @endif
                                </span>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    @php
                                        $expiryDate = strtotime($single_user[0]->userExpiry);
                                        $currentDate = strtotime(date('Y-m-d'));
                                    @endphp
                                    <span>
                                    @if($single_user[0]->userExpiry !== NULL)
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <span>
                                    @if($single_user[0]->trans_system == 'cash')
                                      {{ __('Cash') }}
                                    @elseif($single_user[0]->trans_system == 'bank')
                                      {{ __('Bank') }}
                                    @elseif($single_user[0]->trans_system == 'nagad')
                                      {{ __('Nagad') }}
                                    @elseif($single_user[0]->trans_system == 'bkash')
                                      {{ __('Bkash') }}
                                    @elseif($single_user[0]->trans_system == 'rocket')
                                      {{ __('Rocket') }}
                                    @endif
                                    </span>
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9"><span>
                                    @if($single_user[0]->status == 'active')
                                        {{ __('Active') }}
                                        @elseif($single_user[0]->status == 'inactive')
                                        {{ __('Inactive') }}
                                    @endif
                                </span>
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9"><span>{{ date('d-M-Y', strtotime($single_user[0]->created_at)) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mybtn">
                <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.operator.editType', ['id'=>$single_user[0]->id]) }}">Update Type</a>
                <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('super.operator.extension', ['id'=>$single_user[0]->id]) }}">Extension</a>
