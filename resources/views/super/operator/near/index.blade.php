...
<div class="row page-titles mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="javascript:void(0)">Near Expiry</a></li>
        </ol>
    </div>
</div>
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            <div class="card-header card_headline">
               <h4 class="card-title headline">All Near Expiry License</h4>
            </div>
            <div class="card-body">
              <h4 class="mb-4 basic_headline">Near Expiry Licenses</h4>
              <div class="table-responsive">
                  <table id="example" class="display" style="min-width: 700px">
                      ...
                      <tbody>
                        @php
                          $i=1;
                        @endphp
                      @foreach($all_nearExpiry as $super_user)
                        <tr>
                            <td>{{ $i++ }}</td>
                ...
                @include('super.operator.near.users_modal')
                @include('super.operator.near.users_inactive')
                @include('super.operator.near.users_active')
                @include('super.operator.near.users_approve')
                @include('super.operator.near.users_pending')
                @include('super.operator.near.users_disable')
                        </tr>
                @endforeach
                      </tbody>
                  </table>
