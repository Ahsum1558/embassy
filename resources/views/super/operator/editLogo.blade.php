...
@include('super.includes.alert')
                <form action="{{ route('super.operator.updateLogo', ['id'=>$data_logo->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                            ...
                            <div class="new-arrival-content pr">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9 mybtn">
                                        ...
                                        <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('super.operator.show', ['id'=>$data_logo->id]) }}">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
