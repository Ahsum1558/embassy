...
class IssueController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super.location.issue.index', compact('all_issue'));
    }
    ...
    public function create()
    {
        ...
        return view('super.location.issue.create', [
    ...
    public function show($id)
    {
        ...
        if($issue_single_data->count() > 0){
            return view('super.location.issue.show', compact('issue_single_data'));
        }else{
            return redirect('/super/issue');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if($issue_data->count() > 0){
            return view('super.location.issue.edit', compact('issue_data'));
        }else{
            return redirect('/super/issue');
        }
    }
    ...
    public function editInfo($id)
    {
        ...
        if($issue_data_info->count() > 0){
            return view('super.location.issue.editInfo', [
    ...
    public function inactive($id)
    {
        ...
        return redirect('/super/issue')->with('message', 'The Issue Place is Inactive Successfully');
    }
    ...
    public function active($id)
    {
        ...
        return redirect('/super/issue')->with('message', 'The Issue Place is Active Successfully');
    }
