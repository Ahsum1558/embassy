...
class CityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super.location.city.index', compact('all_city'));
    }
    ...
    public function getDivision(Request $request)
    {
        ...
        return view('super.location.city.ajax',[
    ...
    public function getDistrict(Request $request)
    {
        ...
        if (count($all_district)>0) {
            return view('super.location.city.ajax_district',[
    ...
    public function create(Request $request)
    {
        ...
        return view('super.location.city.create', [
    ...
    public function show($id)
    {
        ...
        if($city_single_data->count() > 0){
            return view('super.location.city.show', compact('city_single_data'));
        }else{
            return redirect('/super/city');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if($city_data->count() > 0){
            return view('super.location.city.edit', compact('city_data'));
        }else{
            return redirect('/super/city');
        }
    }
    ...
    public function editInfo($id)
    {
        ...
        if($city_data_info->count() > 0){
            return view('super.location.city.editInfo', [
    ...
    public function inactive($id)
    {
        ...
        return redirect('/super/city')->with('message', 'The City is Inactive Successfully');
    }
    ...
    public function active($id)
    {
        ...
        return redirect('/super/city')->with('message', 'The City is Active Successfully');
    }
