...
class DistrictController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super.location.district.index', compact('all_district'));
    }
    ...
    public function getDivision(Request $request)
    {
        ...
        return view('super.location.district.ajax',[
    ...
    public function create(Request $request)
    {
        ...
        return view('super.location.district.create', [
    ...
    public function show($id)
    {
        ...
        if($district_single_data->count() > 0){
            return view('super.location.district.show', compact('district_single_data'));
        }else{
            return redirect('/super/district');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if($district_data->count() > 0){
            return view('super.location.district.edit', compact('district_data'));
        }else{
            return redirect('/super/district');
        }
    }
    ...
    public function editInfo($id)
    {
        ...
        if($district_data_info->count() > 0){
            return view('super.location.district.editInfo', [
    ...
    public function inactive($id)
    {
        ...
        return redirect('/super/district')->with('message', 'The District is Inactive Successfully');
    }
    ...
    public function active($id)
    {
        ...
        return redirect('/super/district')->with('message', 'The District is Active Successfully');
    }
