...
class DivisionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super.location.division.index', compact('all_division'));
    }
    ...
    public function create()
    {
        ...
        return view('super.location.division.create', [
    ...
    public function show($id)
    {
        ...
        if($division_single_data->count() > 0){
            return view('super.location.division.show', compact('division_single_data'));
        }else{
            return redirect('/super/division');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if($division_data->count() > 0){
            return view('super.location.division.edit', compact('division_data'));
        }else{
            return redirect('/super/division');
        }
    }
    ...
    public function editInfo($id)
    {
        ...
        if($division_data_info->count() > 0){
            return view('super.location.division.editInfo', [
    ...
    public function inactive($id)
    {
        ...
        return redirect('/super/division')->with('message', 'The Division is Inactive Successfully');
    }
    ...
    public function active($id)
    {
        ...
        return redirect('/super/division')->with('message', 'The Division is Active Successfully');
    }
